...
extern "C"  String_t* TextMesh_get_text_m2892967978 (TextMesh_t2567681854 * __this, const MethodInfo* method)
{
	typedef String_t* (*TextMesh_get_text_m2892967978_ftn) (TextMesh_t2567681854 *);
	static TextMesh_get_text_m2892967978_ftn _il2cpp_icall_func;
	if (!_il2cpp_icall_func)
	_il2cpp_icall_func = (TextMesh_get_text_m2892967978_ftn)il2cpp_codegen_resolve_icall ("UnityEngine.TextMesh::get_text()");
	return _il2cpp_icall_func(__this);
}
...
extern "C"  void Transform_set_forward_m907359846 (Transform_t1659122786 * __this, Vector3_t4282066566  ___value0, const MethodInfo* method)
{
	{
		Vector3_t4282066566  L_0 = ___value0;
		Quaternion_t1553702882  L_1 = Quaternion_LookRotation_m1257501645(NULL /*static, unused*/, L_0, /*hidden argument*/NULL);
