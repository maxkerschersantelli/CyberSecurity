...
struct MagnetMomentU5BU5D_t1726316541  : public Il2CppArray
{
public:
	ALIGN_FIELD (8) MagnetMoment_t1734236852  m_Items[1];

public:
	inline MagnetMoment_t1734236852  GetAt(il2cpp_array_size_t index) const { return m_Items[index]; }
	inline MagnetMoment_t1734236852 * GetAddressAt(il2cpp_array_size_t index) { return m_Items + index; }
	inline void SetAt(il2cpp_array_size_t index, MagnetMoment_t1734236852  value)
	{
		m_Items[index] = value;
	}
};
...
struct SurfaceMaterialU5BU5D_t869604290  : public Il2CppArray
{
public:
